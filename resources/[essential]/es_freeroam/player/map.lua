local blips = {
    -- Basic
    {name="Bar Horses and gays", id=93, x=-565.171, y=276.625, z=83.286},
   -- {name="Stripbar", id=121, x=134.476, y=-1307.887, z=28.983},
    --{name="La Chicha", id=140, x=-1171.42, y=-1572.72, z=3.6636},
    -- Police Stations
    {name="Quartier général du LSPD", id=60, x=425.130, y=-979.558, z=30.711},
